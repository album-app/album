...
class CollectionManager(CollectionInterface):
    ...
    def _resolve(self, str_input):
        ...
        path = check_file_or_url(str_input, self.album.configuration().get_cache_path_tmp_user())
        ...
        if path:
            ...
            if doi:
                ...
                if solution_entry:
                    ...
                    # download DOI
                    path = check_doi(doi["doi"], self.album.configuration().get_cache_path_tmp_user())
    ...
    def retrieve_and_load_resolve_result(self, resolve_result: ResolveResult):
        ...
        resolve_result.loaded_solution = self.album.state_manager().load(resolve_result.path)
