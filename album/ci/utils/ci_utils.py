...
from album.ci import zenodo_api
from album.ci.utils.deploy_environment import get_ci_zenodo_values
from album.core.model.default_values import DefaultValues
from album.core.utils.operations.git_operations import retrieve_single_file_from_head
...
def retrieve_solution_file_path(head):
    ...
    return retrieve_single_file_from_head(head, DefaultValues.cache_path_solution_prefix.value)


def retrieve_yml_file_path(head):
    """Get back the yml file in the top commit of the given head."""
    return retrieve_single_file_from_head(head, DefaultValues.catalog_yaml_prefix.value)
