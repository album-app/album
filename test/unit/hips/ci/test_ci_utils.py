...
class TestCiUtils(TestGitCommon):
    ...
    @patch('hips.ci.ci_utils.__get_zenodo_api')
    @patch('hips.ci.ci_utils.zenodo_api.ZenodoAPI.deposit_create_with_prereserve_doi')
    ...
    @patch('hips.ci.ci_utils.__get_zenodo_api')
    @patch('hips.ci.ci_utils.zenodo_api.ZenodoAPI.deposit_get')
    ...
    @patch('hips.ci.ci_utils.__get_zenodo_api')
    @patch('hips.ci.ci_utils.zenodo_api.ZenodoAPI.deposit_get')
    @patch('hips.ci.ci_utils.zenodo_api.ZenodoDeposit.new_version', return_value=True)
    ...
    @patch('hips.ci.ci_utils.zenodo_api.ZenodoDeposit.update_file', return_value=True)
    @patch('hips.ci.ci_utils.zenodo_api.ZenodoDeposit.create_file', return_value=True)
