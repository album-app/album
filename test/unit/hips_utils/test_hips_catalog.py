...
from hips.deploy import deploy_keys
from hips.hips_base import HipsDefaultValues
from hips_utils.hips_catalog import Catalog, CatalogIndex
...
class TestHipsCatalog(TestHipsCommon):
    ...
    @unittest.skip("tested in git_operations.download_repository")
    ...
    @patch('hips_utils.hips_catalog.get_index_src')
...
class TestHipsCatalogIndex(TestHipsCommon):
    ...
    @patch('hips_utils.hips_catalog.CatalogIndex._find_all_nodes_by_attribute')
    ...
    @patch('hips_utils.hips_catalog.RenderTree', return_value="")
