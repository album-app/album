...
class TestEnvironment(TestUnitCommon):
    ...
    @patch('album.core.model.environment.create_path_recursively', return_value="createdPath")
    def test_prepare_env_file_valid_url(self, create_path_mock, download_mock):
        # mocks
    ...
    @patch('album.core.model.environment.create_path_recursively', return_value="createdPath")
    def test_prepare_env_file_invalid_StringIO(self, create_path_mock):
    ...
    @patch('album.core.model.environment.create_path_recursively', return_value="createdPath")
    def test_prepare_env_file_valid_StringIO(self, create_path_mock):
        self.environment.cache_path = Path(tempfile.gettempdir())
