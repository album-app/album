...
class TestCollectionIndex(TestUnitCommon):
    ...
    def test_get_solution_by_catalog_grp_name_version(self):
        ...
        r = self.test_catalog_collection.get_solution_by_catalog_grp_name_version(
            "catalog_id_exceptionell", Identity("grp_exceptionell", "name_exceptionell", "version_exceptionell")
        )
        r.pop("install_date")
    ...
    def test_get_solutions_by_grp_name_version(self):
        ...
        r = self.test_catalog_collection.get_solutions_by_grp_name_version(Identity("grp", "name", "version"))
    ...
    def test_update_solution(self):
        ...
        self.test_catalog_collection.update_solution("cat2", Identity("grp", "name", "version"), {}, SolutionHandler.get_solution_keys())
    ...
    def test_remove_solution(self):
        ...
        self.test_catalog_collection.remove_solution("cat2", Identity("grp", "name", "version"))
        ...
        self.test_catalog_collection.remove_solution("cat1", Identity("grp_d", "name_d", "version_d"))
    ...
    def test_is_installed(self):
        ...
        self.assertFalse(self.test_catalog_collection.is_installed("cat1", Identity("grp", "name", "version")))
