...
class TestScriptManager(TestUnitCoreCommon):
    ...
    def test_build_queue_steps_list(self):
        ...
        self.script_manager._create_solution_run_with_parent_script_standalone = create_solution_run_with_parent_script_standalone

        create_solution_run_script_standalone = MagicMock(return_value=None)
        self.script_manager._create_solution_run_script_standalone = create_solution_run_script_standalone
    ...
    def test_build_steps_queue_no_parent(self):
        ...
        self.script_manager._build_steps_queue(que, steps, ScriptCreatorRun(), False, [
    ...
    def test_build_steps_queue_parent(self):
        ...
        self.script_manager._build_steps_queue(que, steps, scr, False, [
            None])  # [None] mocks the namespace object from argument parsing of the parent

        # assert
        self.assertEqual(4, resolve_require_installation_and_load.call_count)  # 2 times step, 2 times parent
        ...
        r2 = SolutionGroup(parent_parsed_args=[None], parent=resolve_require_installation.return_value,
    ...
    def test_build_steps_queue_run_immediately(self):
        ...
        self.script_manager._build_steps_queue(que, steps, ScriptCreatorRun(), True, [None])
