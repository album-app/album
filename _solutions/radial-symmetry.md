...
covers:
- description: Exemplary noisy input data and the resulting segmentation and point
    detection of radial symmetry.
...
sample_outputs:
- description: Table including detected point center positions generated by running
    this solution.
