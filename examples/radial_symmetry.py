...
hips.setup(
    ...
    documentation="",
    covers=[{
        "source": "/assets/images/solutions/radial-symmetry/cover.png",
        "description": "Exemplary noisy input data and the resulting segmentation and point detection of radial symmetry."
     }],
    sample_inputs=[{
        "source": "/assets/images/solutions/radial-symmetry/radial_symmetry_example_input.tif",
        "description": "Noisy input demo data generated by XY"
    }],
    sample_outputs=[{
        "source": "/assets/images/solutions/radial-symmetry/radial_symmetry_example_result.txt",
        "description": "Table including detected point center positions generated by running this solution."
    }],
